...
create table if not exists public.admin_stats (
  ...
  new_users_yesterday int default 0,
  new_maps_today int default 0,
  new_maps_yesterday int default 0,
  avg_maps_per_user numeric default 0,
  avg_chats_per_user numeric default 0,
  avg_nodes_per_map numeric default 0,
  heatmap_days jsonb default '[]'::jsonb,
  map_analytics jsonb default '{}'::jsonb,
  latest_users jsonb default '[]'::jsonb,
  latest_maps jsonb default '[]'::jsonb,
