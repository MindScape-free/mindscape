...
const securityHeaders = [
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://placehold.co https://picsum.photos https://image.pollinations.ai https://gen.pollinations.ai https://pollinations.ai https://*.pollinations.ai https://*.googleusercontent.com https://grainy-gradients.vercel.app",
      "connect-src 'self' https://dnwsjvxitcndeqepovvo.supabase.co wss://dnwsjvxitcndeqepovvo.supabase.co https://dnwsjvxitcndeqepovvo.supabase.co/auth/v1 https://gen.pollinations.ai https://image.pollinations.ai https://pollinations.ai https://*.pollinations.ai https://r.jina.ai https://*.googleapis.com https://www.googleapis.com https://apis.google.com",
