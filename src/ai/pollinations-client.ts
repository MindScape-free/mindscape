...
// Registry of available models (synced with Pollinations API — free only)
const AVAILABLE_MODELS: ModelDef[] = [
    // --- FAST ---
    { id: 'gemini-fast', feature: 'fast', description: 'Gemini Flash Lite 3.1', context: 32000, isFree: false },
    ...
    { id: 'gemini-search-fast', feature: 'fast', description: 'Gemini Flash Lite + Search', context: 32000, isFree: false },

    // --- CREATIVE & HIGH-QUALITY ---
    { id: 'openai', feature: 'creative', description: 'GPT-5 Mini', context: 128000, isFree: true },
    { id: 'claude-fast', feature: 'creative', description: 'Claude Haiku 4.5', context: 128000, isFree: false },
    { id: 'claude', feature: 'creative', description: 'Claude Sonnet 4.5', context: 200000, isFree: false },
    ...
    { id: 'gemini', feature: 'creative', description: 'Gemini 2.5 Flash', context: 32000, isFree: false },
    ...
    { id: 'kimi', feature: 'reasoning', description: 'Kimi K2', context: 256000, isFree: false },
    { id: 'kimi-k2.6', feature: 'reasoning', description: 'Kimi K2.6', context: 256000, isFree: true },
    { id: 'perplexity-reasoning', feature: 'reasoning', description: 'Perplexity Sonar Reasoning', context: 32000, isFree: false },
    { id: 'perplexity', feature: 'reasoning', description: 'Perplexity Sonar Pro', context: 32000, isFree: false },
    { id: 'gemini-search', feature: 'reasoning', description: 'Gemini 2.5 Flash + Search', context: 32000, isFree: false },

    // --- CODING & SAFETY ---
    { id: 'qwen-coder', feature: 'coding', description: 'Qwen3 Coder 30B', context: 32000, isFree: true },
    { id: 'qwen-coder-large', feature: 'coding', description: 'Qwen3 Coder 235B', context: 32000, isFree: false },
