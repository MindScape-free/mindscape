        ...
        <div className="fixed top-[75px] left-1/2 -translate-x-1/2 z-50 transition-all duration-300 w-fit max-w-[95vw]">
            <div className="glass-panel p-1.5 rounded-2xl flex items-center gap-2 shadow-2xl ring-1 ring-white/10 backdrop-blur-xl bg-black/40 overflow-x-auto no-scrollbar">
                ...
                <div className="flex items-center gap-2 px-2">
                    ...
                    {/* File Aware Toggle - HIGHLIGHTED GOLD/YELLOW */}
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    className={cn(
                                        "h-9 gap-2 text-[10px] font-black font-orbitron uppercase tracking-widest px-4 rounded-xl transition-all active:scale-95 shadow-[0_0_10px_-4px_rgba(234,179,8,0.3)]",
                                        useFileAware
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    className="h-9 gap-2 text-[10px] font-black font-orbitron uppercase tracking-widest px-4 rounded-xl bg-blue-500/10 text-blue-400 border border-blue-500/20 hover:bg-blue-500/20 hover:scale-105 transition-all active:scale-95 shadow-[0_0_10px_-4px_rgba(59,130,246,0.3)]"
                                >
